package com.xzg.wlxx.lombok.processors;
...
public class RouterManager {
    ...
    public static final String INIT_CLASS = "com.xzg.wlxx.TestRouterInit";
    public static final String INIT_PACKAGE = "com.xzg.wlxx";
