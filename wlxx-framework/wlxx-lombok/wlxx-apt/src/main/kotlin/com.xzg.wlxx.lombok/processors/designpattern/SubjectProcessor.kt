...
package com.xzg.wlxx.lombok.processors.designpattern
...
import com.xzg.wlxx.lombok.annotation.designpattern.ISubject
import com.xzg.wlxx.lombok.annotation.designpattern.Observer
import com.xzg.wlxx.lombok.annotation.designpattern.Subject
import com.xzg.wlxx.lombok.base.SingleAnnotationProcessor
import com.xzg.wlxx.lombok.util.asField
import com.xzg.wlxx.lombok.util.asGetter
import com.xzg.wlxx.lombok.util.getValue
...
internal class SubjectProcessor : SingleAnnotationProcessor() {
    ...
    private fun getJavaFile(curElement: TypeElement): JavaFile {
        ...
        val curISubject = TypeSpec.interfaceBuilder(
            "${
    ...
    inner class MyTreeTranslator(private val rootClazzName: Name) : TreeTranslator() {
        ...
        override fun visitTopLevel(cu: JCTree.JCCompilationUnit) {
            cu.defs = cu.defs
                ...
                .prepend(
                    treeMaker.Import(
                        treeMaker.Select(
                            treeMaker.Ident(names.fromString("com.fashare.javasugar.annotation.designpattern")),
                            names.fromString("ISubject")
                        ), false
                    )
                )
        ...
        private fun makeISubjectFieldAndGetter(jcClassDecl: JCClassDecl) {
            mObservers.forEach { observer ->
                ...
                val iSubjectStub =
                    treeMaker.Select(treeMaker.Ident(names.fromString("ISubject")), names.fromString("Stub"))
